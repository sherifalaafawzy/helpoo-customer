...
class DeviceInfoService {
  ...
  static DeviceInfoService _instance = DeviceInfoService._internal();
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      if (kIsWeb) {
        deviceData.addAll(_readWebBrowserInfo(await deviceInfoPlugin.webBrowserInfo));
      } else {
        deviceData.addAll( switch (defaultTargetPlatform) {
